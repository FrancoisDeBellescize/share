...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return array(
            ...
            array('FooBundle:Post:dashboard.html.twig', 'FooBundle:Post:dashboard.html.twig', '@FooBundle/Resources/views/Post/dashboard.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')),
