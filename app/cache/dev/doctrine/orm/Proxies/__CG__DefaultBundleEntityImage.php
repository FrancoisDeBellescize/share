 ...
 */
class Image extends \DefaultBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DefaultBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'DefaultBundle\\Entity\\Image' . "\0" . 'folder', 'media'];
        }
